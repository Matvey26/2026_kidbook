...
Компьютер состоит из множества частей: процессор думает, память хранит информацию, [диск](file_system.md) записывает данные, [экран](window_manager.md) показывает картинки. Каждая часть работает по-своему и говорит на своём языке.
