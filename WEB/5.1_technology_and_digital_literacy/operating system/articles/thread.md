...
**Поток выполнения** (или просто **поток**) — это отдельный путь выполнения задач внутри [программы](process.md). 
...
- На [экране](window_manager.md) двигаются персонажи
- Играет музыка
...
**Процесс** — это запущенная программа со всеми своими ресурсами: памятью, [файлами](file_system.md), настройками. Каждый процесс живёт отдельно от других.
